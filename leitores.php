...
section .card-custom-leitores .header-custom{
    font-size: 20px;
    font-family: 'Poetsen one', sans-serif, serif;
    
}

section .card-custom-leitores h5{
...
section .card-custom-leitores .card:not(:hover){
    transition: .5s;
}
section .card-custom-leitores .card:hover{
    box-shadow: 1px 1px 4px 4px #967ADC;
    transition: .5s;
}

section .card-custom-leitores{
    height: 1px;
}
  ...
  section .leitores-custom button{
    background-color: #967ADC;
    color: #ffff;
    font-weight: 600;
    font-size: 20px;
  ...
  section .leitores-custom button:hover{
    background-color: #350ADC;
  }

  section .list-group-item {
          border-color: #967ADC; /* Cor da borda das linhas */
        ...
        section .form-check-input {
            border: 2px solid #000; /* Cor da borda do checkbox */
            background-color: #fff; /* Fundo do checkbox */
            box-shadow: none;
            cursor: pointer;
        }
        ...
        section .form-check-input:active {
            box-shadow: none; /* Remove a sombra no estado focado e pressionado */
        }
  ...
  @media (max-width: 1150px) {
    section .leitores-custom .list-group-item {
        display: flex;
    ...
    section .leitores-custom .form-check-input {
        margin-bottom: 10px;
    }

    section .leitores-custom .form-check-label {
        margin-bottom: 10px;
    }
...
section .leitores-custom .button-add{
    margin-top: 30px;
}
    ...
    <section>
        ...
        <ul class="list-group">
            <li class="list-group-item d-flex justify-content-between flex-row">
                <input class="form-check-input me-1 itemCheckbox" type="checkbox" value="" id="firstCheckbox">
                <label class="form-check-label" for="firstCheckbox">Leitor 1 - IP 10.10.10.10</label>
                <div class="button-group">
                    <button class="btn btn-primary">Limpar Leitor</button>
                    <button class="btn btn-secondary" onclick="adicionarFoto()">Adicionar Foto</button>
                </div>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <a class="dropdown-item" href="#">Limpar Leitor</a>
                        <a class="dropdown-item" href="#" onclick="adicionarFoto()">Adicionar Foto</a>
                    </div>
                </div>
            </li>
        ...
        <button class="button-add">Adicionar Leitor</button>
    </div>
